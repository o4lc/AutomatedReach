...
class MNBabOptimizer:
    ...
    def bound_root_subproblem(
        ...
        # print("deep poly upper bounds:", deep_poly_ubs)
        ...
        # print("alpha upper bounds:", alpha_ubs)
    ...
    def bound_minimum_with_deep_poly(
        ...
        # ).all(), f"output_lb: {output_lbs}; output_ub_min: {ubs_of_minimum} u - l: {input_ub - input_lb}\n" \
